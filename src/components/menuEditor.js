...
const MenuEditor = ({ isLogin }, prop) => {
    ...
    const logOut = () => {
        localStorage.removeItem("tokenEditor")
        localStorage.removeItem('authEditor')
            ...
            <nav className='head bg-danger'>
                ...
                <ul >
                    ...
                    <li >
                        ...
                        <Link  style={{ display: prop.to === 'login' ? 'none' : 'block' }} className='btn btn-success loginButton '>

                            <p className='buttonTextLayout'>{
                                isLogin ? JSON.parse(localStorage.getItem("authEditor")).editor.name :
                                    "Login"}</p>
                ...
                {isLogin ?
                    <div className='navbar ' >
                        ...
                        <ul>
                            <li className='nav-item '><Link to={'/editor-products'}>Ürünler</Link></li>
                            <li className='nav-item '><Link to={'/editor-users'}>Kullanıcılar</Link></li>
